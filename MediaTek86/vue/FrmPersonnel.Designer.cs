namespace MediaTek86.vue
{
    partial class FrmPersonnel
    {
        ...
        private void InitializeComponent()
        {
            ...
            // dgvPersonnel
            // 
            this.dgvPersonnel.ColumnHeadersHeightSizeMode =
                System.Windows.Forms
                .DataGridViewColumnHeadersHeightSizeMode
                .AutoSize;

            this.dgvPersonnel.Columns.AddRange(
            ...
            this.dgvPersonnel.Location =
                new System.Drawing.Point(115, 36);

            this.dgvPersonnel.Name =
                "dgvPersonnel";

            this.dgvPersonnel.Size =
                new System.Drawing.Size(543, 277);

            this.dgvPersonnel.TabIndex = 0;

            this.dgvPersonnel.CellContentClick +=
            ...
            this.btnAjouter.Location =
                new System.Drawing.Point(120, 330);
            ...
            this.btnModifier.Location =
                new System.Drawing.Point(260, 330);
            ...
            this.btnSupprimer.Location =
                new System.Drawing.Point(400, 330);
            ...
            // btnAbsence
            // 
            this.btnAbsence.Location =
                new System.Drawing.Point(540, 330);

            this.btnAbsence.Name =
                "btnAbsence";

            this.btnAbsence.Size =
                new System.Drawing.Size(75, 23);

            this.btnAbsence.TabIndex = 4;

            this.btnAbsence.Text =
                "Absences";

            this.btnAbsence.UseVisualStyleBackColor =
                true;

            this.btnAbsence.Click +=
                new System.EventHandler(
                    this.btnAbsence_Click
                );

            // 
            // idpersonnel
            // 
            this.idpersonnel.HeaderText =
                "ID";

            this.idpersonnel.Name =
                "idpersonnel";
